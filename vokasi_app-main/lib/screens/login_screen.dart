          ...
          Stack(
            children: [
              ...
              Positioned(
                ...
                top: 0.5338 * MediaQuery.of(context).size.height,
                bottom: 0.4162 * MediaQuery.of(context).size.height,
              ...
              Positioned(
                left: 0.3444 * MediaQuery.of(context).size.width,
                right: 0.3444 * MediaQuery.of(context).size.width,
                top: 0.6162 * MediaQuery.of(context).size.height,
                bottom: 0.3588 * MediaQuery.of(context).size.height,
                child: InkWell(
                  onDoubleTap: () {
                    Navigator.push(
                      context,
